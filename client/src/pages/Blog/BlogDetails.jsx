  ...
  return (
    <div>
      <Card className="bg-gray-600 text-white">
        <CardHeader>
          <div>
            <Button className="bg-black hover:bg-white hover:text-black hover:border-black border-2" asChild>
              ...
              {blogData && blogData.blog.length > 0 ?
                 ...
                 blogData.blog.map(blog =>
                  ...
                  <TableCell className="flex gap-3">
                    <Button variant="outline" className="text-red-500 hover:bg-black hover:text-white" asChild>
