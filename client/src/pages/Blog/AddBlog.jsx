        ...
        <CardContent>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Select onValueChange={field.onChange} default={field.value}>
              ...
              <Button
                type="submit"
                className="w-full  bg-black hover:bg-white hover:text-black hover:border-black border-2 rounded"
              >
                Submit
              </Button>
            </form>
